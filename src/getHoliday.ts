...
import { getQueenElizabethIIRemembranceDay } from './holidays/queenElizabethIIRemembranceDay.js';
...
const holidayFunctions = {
	...
	[Holiday.QUEEN_ELIZABETH_II_REMEMBRANCE_DAY]: getQueenElizabethIIRemembranceDay,
} as const;
